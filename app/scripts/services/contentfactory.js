...
angular.module('hackdayApp')
  .factory('contentFactory', function () {
    ...
    var ReferenceCard = function (text, imageId) {
      this.type = 'reference';
      this.text = text;
    ...
    var LearningCard = function (text, imageId) {
      this.type = 'learning';
      this.text = text;
      this.imageId = imageId;
      this.frontUp = false;
    ...
    rawItems.forEach(function (item) {
      var referenceCard = new ReferenceCard(item.l1_text, item.image_id);
      var learningCard = new LearningCard(item.l2_text, item.image_id);
